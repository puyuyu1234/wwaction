...
const BLOCKDATA = {
    ...
    "x": new BlockData([24], 100, { hitbox: new Rectangle(1, 12, 14, 4), damage: 1 }),
    "y": new BlockData([25], 0),
    "z": new BlockData([26], 100, { hitbox: new Rectangle(1, 0, 14, 4), damage: 1 }),
    "A": new BlockData([27], 15),
    "B": new BlockData([28], 15),
    "C": new BlockData([29], 15),
    "D": new BlockData([30], 1),
    "E": new BlockData([31], 1),
    "F": new BlockData([32], 100, { hitbox: new Rectangle(12, 1, 4, 14), damage: 1 }),
    "G": new BlockData([33], 100, { hitbox: new Rectangle(0, 1, 4, 14), damage: 1 }),
    "H": new BlockData([34, 53, 54, 55], 200, { freq: 12, loop: true }),
        ...
        new StageData(
            ...
            [
                [
                    ...
                    "bbbbbbbbilr  AC   AC   AC  qlllr      qllllllsh 53ede35 gbbbbb",
                    "llllllllllr                qlllr      qlllllllsbbbbbbbbbilllll",
                    "llllllllllr                qlllr      qlllllllllllllllllllllll",
                    "llllllllllr                qlllr      qlllllllllllllllllllllll",
                ],
            ],
            ["y"],
