...
import { easeInSine, easeOutSine } from '@/utils/easing'

/**
 * シーン遷移演出
 * 斜めに傾いた黒矩形が左右から開閉するアニメーション
 * legacy: stage.js:166-213
 */
export class SceneTransition {
  ...
  // アニメーション定数（legacy実装: stage.js:168-173）
  ...
  update(): void {
    ...
    if (this.isOpening) {
      ...
      // legacy: black1.x = easeInSine(x + startDx, x + dx, black1.time, moveTime)
      ...
      // legacy: black1.x = easeOutSine(x + dx, x + startDx, black1.time, moveTime)
